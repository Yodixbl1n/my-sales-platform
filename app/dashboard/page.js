...
export default function Dashboard() {
  ...
  const modules = [
    { id: 1, title: 'Введение и базовые понятия',
      lessons: [
    'Философия продаж: от «впаривания» к помощи',
    'Глоссарий: Лид, Контакт, Потребность',
    'Глоссарий: СВЭ, Возражение, ЛПР, Оффер',
    'Глоссарий: Квалификация, Клоузинг, Upsell, LTV',
    '5 этапов продажи + установление контакта',
    'Архитектура идеального звонка — Фреймворк C.U.P.',
    'Выявление потребности: вопросы и слушание',
    'Презентация, вопросы, завершение',
    'Управление внутренним состоянием (НЛП)',
    'Прослушка, самоанализ, спарринги',
    'Методика ФБР, эмоциональный дожим, Джим Кэмп',
    'Практика и типичные ошибки Модуля 1'
  ] },
    { id: 2, title: 'Программирование диалога (СПИН)',
      lessons: [
        'Программирование диалога и фрейминг',
        'СПИН: Ситуационные вопросы (С)',
        'СПИН: Проблемные вопросы (П)',
        'СПИН: Извлекающие вопросы (И)',
        'СПИН: Направляющие вопросы (Н)',
        'Экологичность СПИН и вопрос-крючок',
        'Карта ЛПР и сквозной скрипт',
        'Фреймворки квалификации: BANT, CHAMP, GPCT, MEDDIC',
        'Практика и ошибки Модуля 2',
        'Практика и типичные ошибки'
      ] },
    { id: 3, title: 'Архитектура ценности',
      lessons: [
        'Инжиниринг пре-убеждения',
        'Математика ценности: формула Хормози',
        'Пять инструментов усиления оффера',
        'Стратегия «рынка одного игрока»',
        'Психологические усилители: 7 принципов Чалдини',
        'Лид-магниты и экономика внимания',
        'Триггер единства и правило 100',
        'Практика и ошибки Модуля 3',
        'Практика и типичные ошибки'
      ] },
    { id: 4, title: 'Архитектура возражений',
      lessons: [
        ...
        'Возражения «у конкурентов дешевле» и «нужно посоветоваться»',
        'Возражение «нет денег» и экологичное увольнение',
        'Защита цены (Кеннеди) и Feel-Felt-Found',
        'Эффект рамки и избегание потерь',
        'Якорный эффект в переговорах о цене',
        'Большая картина: как соединить C.U.P., AAAR и Бумеранг',
    'Практика и ошибки Модуля 4',
        'Практика и типичные ошибки',
    'Домашнее задание по Модулю 4'] },
    { id: 5, title: 'Максимизация прибыли',
      lessons: [
        'Анатомия скидки и правило обмена уступками',
        'Архитектура Up-sell и Cross-sell',
        'LTV и пост-продажное обслуживание',
        'RFM-анализ: как находить самых ценных клиентов',
        'Почему удержание важнее привлечения: статистика',
        'Окно возможностей для Up-sell: момент решает всё',
        'Отток клиентов (churn) и проактивное внимание',
        'NPS (индекс потребительской лояльности)',
        'Практика и типичные ошибки'
      ] },
    { id: 6, title: 'Продвинутые техники',
      lessons: [
        'Метод «Прямой линии» Джордана Белфорта',
        'Правило «трёх десяток» Белфорта',
        'Продажа через асимметрию информации (модель BlackRock)',
        'Фреймворк квалификации MEDDIC',
        'Управление тональностью голоса',
        'Темп и тон речи как маркер экспертности',
        'Управление фреймами Орена Клаффа (Pitch Anything)',
        'Тактическая эмпатия Криса Восса (Never Split the Difference)',
        'Негативный реверс Дэвида Сэндлера (Sandler Selling)',
        'Защита цены методом брекетинга (Bracketing)',
        'Упреждающий удар по возражениям (Objection Preemption)',
        'Модель асимметричного доминирования (эффект приманки)',
        'Фреймворк «Институционального захвата» (Lock-in Strategy)',
        'Практика и типичные ошибки'
      ] },
    { id: 7, title: 'Нейрохакинг продаж',
      lessons: [
        'Дофаминовое «выжигание» и петля ожидания',
        'Эффект Зейгарник и теория информационного разрыва',
        'Захват амигдалы через «иллюзию угрозы» (Amygdala Hijack)',
        'Нейро-зеркалирование через «эффект собственности»',
        'Окситоциновый взлом «свой/чужой»',
        'Серотониновый сдвиг статуса (The Serotonin Status Swap)',
        'Взлом кортизола через управляемый стресс',
        'Нейролингвистический рефрейминг контекста (Sleight of Mouth)',
        'Феномен Баадера-Майнхоф (иллюзия частотности)',
        'Практика и типичные ошибки'
      ] },
    { id: 8, title: 'Ментальное превосходство',
      lessons: [
        'BATNA — фундамент реальной переговорной силы (Фишер и Юри)',
        'Адаптация языка под тип собеседника (спиральная динамика)',
        'Работа со слепой зоной клиента',
        'Сторителлинг с встроенным действием',
        'Негативный реверс на этапе закрытия',
        'Работа с обобщениями клиента (техника «квантора общности»)',
